...
Application streamlit pour les travaux pratiques de physiologie vegetale

3 fonctions :
  - Voir la table de données actuelle lié à une expérience
...
Les fichiers concernés sont :
  ...
  - Pour la séance sur la photosynthèse :
    1. Mesure sur l'IRGA
